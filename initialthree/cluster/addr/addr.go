...
func (this *Addr) AtomicGetNetaddr() *net.TCPAddr {
	return (*net.TCPAddr)(atomic.LoadPointer((*unsafe.Pointer)(unsafe.Pointer(&this.Net))))
}

func (this *Addr) AtomicSetNetaddr(addr *net.TCPAddr) {
	atomic.StorePointer((*unsafe.Pointer)(unsafe.Pointer(&this.Net)), unsafe.Pointer(addr))
}
