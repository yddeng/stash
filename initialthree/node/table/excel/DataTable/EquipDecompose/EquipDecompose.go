...
func GetID(key int32)*EquipDecompose{
	v := Table_.indexID.Load().(map[int32]*EquipDecompose)[key]
	if v == nil{
...
func GetIDMap() map[int32]*EquipDecompose {
	return Table_.indexID.Load().(map[int32]*EquipDecompose)
}
...
func init(){
	Table_.xlsxName = "EquipDecompose.xlsx"
...
func (this *Table)Load(path string){
	...
	tmpIDMap := map[int32]*EquipDecompose{}
