...
func GetID(key int32)*PlayerCard{
	v := Table_.indexID.Load().(map[int32]*PlayerCard)[key]
	if v == nil{
...
func GetIDMap() map[int32]*PlayerCard {
	return Table_.indexID.Load().(map[int32]*PlayerCard)
}
...
func init(){
	Table_.xlsxName = "PlayerCard.xlsx"
