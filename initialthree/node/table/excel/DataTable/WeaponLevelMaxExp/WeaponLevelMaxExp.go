...
func GetID(key int32)*WeaponLevelMaxExp{
	v := Table_.indexID.Load().(map[int32]*WeaponLevelMaxExp)[key]
	if v == nil{
...
func GetIDMap() map[int32]*WeaponLevelMaxExp {
	return Table_.indexID.Load().(map[int32]*WeaponLevelMaxExp)
}
...
func init(){
	Table_.xlsxName = "WeaponLevelMaxExp.xlsx"
...
func (this *Table)Load(path string){
	...
	tmpIDMap := map[int32]*WeaponLevelMaxExp{}
